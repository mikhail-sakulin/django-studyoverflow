...
def sync_default_groups(sender, **kwargs):
    """
    Обработчик сигнала post_migrate: создаёт/обновляет группы Moderators и
    StaffViewers с нужными правами.
    """
...
def log_user_login(sender, request, user, **kwargs):
    """
    Обработчик сигнала, срабатывающий при успешной авторизации пользователя.
...
def log_user_signup(sender, request, user, **kwargs):
    """
    Обработчик сигнала (из allauth), срабатывающий при регистрации нового пользователя.
...
def log_user_logout(sender, request, user, **kwargs):
    """
    Обработчик сигнала, срабатывающий при выходе пользователя из системы.
...
def log_user_deletion(sender, instance, **kwargs):
    """
    Обработчик сигнала, срабатывающий после удаления пользователя.
...
def log_user_login_failed(sender, credentials, request, **kwargs):
    """
    Обработчик сигнала, срабатывающий при неудачной попытке входа.
